...
public class MainActivity extends BaseActivity implements
  ...
  UserPreferencesFragment.OnPreferencesListener {
                ...
                (databaseError, databaseReference) -> {
                    ...
                    if (databaseError != null && databaseError.getCode() < 0) {
                        ...
                        Snackbar.make(findViewById(
                            ...
                            getString(R.string.err_match_not_created),
    ...
    public void onPopulated() {
        ...
        hideProgressDialog();
        if (mUserPreference != null && !mUserPreference.TeamId.equals(BaseActivity.DEFAULT_ID)) {
            ...
            FirebaseDatabase.getInstance().getReference().updateChildren(
                ...
                (databaseError, databaseReference) -> {
                    ...
                    if (databaseError != null && databaseError.getCode() < 0) {
                        ...
                        Snackbar.make(
                            findViewById(R.id.main_fragment_container),
                            getString(R.string.err_trends_not_created),
                            Snackbar.LENGTH_LONG)
                            .show();
                    }
                });
